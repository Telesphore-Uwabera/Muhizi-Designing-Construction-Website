...
<head>
    ...
    <title>Trainings | Muhizi Construction & Design</title>
    ...
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Computer System Academy</title>
    <link rel="stylesheet" href="asseta/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="asseta/icons/style.css">
    ...
    .mybutton:hover {
        transition: .5s cubic-bezier(0, 1, .3, 1), opacity .1s .75s ease-out;
...
<body>
    ...
    <header class="header_section">
        ...
        <div class="header_bottom">
            <div class="container-fluid">
                <nav class="navbar navbar-expand-lg custom_av-container">
    ...
    <div class="main py-5"
        style="background-image: url(asseta/images/training.jpg);background-size: cover;margin-top: -16px;">
        <div class="main2 p-3" style="background-color: rgba(0,0,0,0.45);margin-top: -16px;">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <br><br><br>
                        <h1 class="display-4 text-white">We provide various trainigs</h1>
                        <br>
                        <h5 class="font-weight-normal text-white"><i>
                                At MUHIZI DESIGNING AND CONSTRUCTION, we provide different trainings as we progress. The
                                trainees from MUHIZI DESIGNING AND CONSTRUCTION are competitive to the job market. We
                                give them the senior construction and architectural modern knowledge.</i></h5><br>
                    </div>
                </div>
                <div class="row py-2">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-3"></div>
                            <div class="col-md-6">
                                <center><a href="#Training" style="text-decoration: none;"><button
                                            class="btn btn-lg text-gray-dark btn-block mybutton"
                                            style="border-radius: 50px; background-color:#004445; color: #ffffff;">Explore
            ...
            <div class="row">
                    ...
                    <div class="training-card">
                        ...
                        <div class="card-content">
                            <p>The Architectural and Built Environment Department offers education and training in
                                ...
                                professionals with skills for sustainable development and urban planning, preparing them
                                to address modern challenges.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="training-card">
                        ...
                        <div class="card-content">
                            <p>The Highway and Public Infrastructure Department focuses on planning, designing, and
                                ...
                                sustainability, fostering economic growth and improving communities' quality of life.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="training-card">
                        ...
                        <div class="card-content">
                            <p>The Structural Analysis Department employs advanced computational tools to ensure safety
                                and efficiency in buildings, bridges, and infrastructure projects, contributing to
                                resilient and cost-effective structural solutions.</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="contact wow fadeInUp" id="contact">
        <div class="container">
            <div class="section-header text-center">
                <h3 style="color: #004445">Do you want to be trained?</h3>
                <h2>For Any Query</h2>
            </div>
            <div class="row">
