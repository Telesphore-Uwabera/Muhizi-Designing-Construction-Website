    ...
    yc = (e, t) => {
      ...
      return Ro(n)
        ...
        : n
          ? Fr(n)
            ? M.some(
                e ? Ya.before(n) : Po((o = n)) ? Ya.before(o) : Ya.after(o),
              )
            : ((e, t, n) => {
                ...
                .bind((e) => {
                  ...
                  if (r.length > 0) {
                    if (o) return M.some(pp.partialTable(r, M.none()));
                    {
                      const e = kp(n, t);
                      return M.some(
                        pp.partialTable(r, M.some({ ...t, rng: e })),
                      );
                    }
                  }
                  return M.none();
            ...
            return M.from(e.selection.getStart(!0))
              .bind((o) =>
                ih(
                  ...
                  (n) =>
                    ce(t, (t) =>
                      ((t, n) => (fh(e, t.dom, n) ? M.some(n) : M.none()))(
                        n,
                        t,
                      ),
                    ),
            ...
            : (t && Io(o.getNode())) || (!1 === t && Io(o.getNode(!0)))
              ? ((e, t, n, o) => {
                  ...
                  return dp(fn(e), fn(n.getNode()))
                    .map((e) =>
                      Yr(e) ? zC.remove(e.dom) : zC.moveToElement(r),
                    )
                      ...
                      : ((e, t, n) =>
                          ((e, t) => {
                            const n = t.getNode(!1 === e),
                              o = e ? "after" : "before";
                            return (
                              Co(n) && n.getAttribute("data-mce-caret") === o
                            );
                          })(t, n)
                            ? ((e, t) =>
                                e && Io(t.nextSibling)
                                  ...
                                  : !1 === e && Io(t.previousSibling)
                                    ? M.some(
                                        zC.moveToElement(t.previousSibling),
                                      )
